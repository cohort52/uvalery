const validationConfig = {
    formSelector: '.add-vacancy__form',
    inputSelector: '.add-vacancy__input',
    fieldsetSelector: '.add-vacancy__fieldset',
    submitButtonSelector: '.add-vacancy__save-button',
    inactiveButtonClass: 'add-vacancy__save-button_invalid',
    inputErrorClass: 'add-vacancy__input_type_error',
    errorClass: 'add-vacancy__error_type_visible'
};
