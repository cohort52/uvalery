...
export const resumeList = [
  ...
  },
  {
    ...
    description: 'Меня зовут Дарья. Я занимаюсь преподаванием более 5 лет. Имею опыт работы с детьми от 4 и до 18 лет. Также занимаюсь со студентами и взрослыми. Преподавала в онлайн школе. Нахожу ко всем индивидуальный подход.',
  ...
  },
  {
    ...
    grafic: 'Удаленная работа Полный день',
    pay: '50000',
    published: '6 дней назад'
  },
  {
    image: 'https://images.unsplash.com/photo-1616065298043-67646192dcb5?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1964&q=80',
    job: 'Координатор',
    name: 'Иванова Мария',
    age: '26 лет',
    city: 'Омск',
  ...
  {
    image: 'https://images.unsplash.com/photo-1629726248957-001e3e024267?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80',
    job: 'Координатор',
    name: 'Иванова Мария',
    age: '26 лет',
    city: 'Омск',
